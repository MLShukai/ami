...
image_path = PROJECT_ROOT / "data/random_observation_action_log/validation/000000.jpg"
...
torchvision.io.write_png(reconstruction.squeeze(0).byte().cpu(), str(PROJECT_ROOT / "data" / "reconstruction.png"))
